public class Essay extends AbGrade {
	/*// Constructor for a Essay, which only requires a name and worth
	...
	// Constructor for a Essay, which requires a name, a worth, and mark
