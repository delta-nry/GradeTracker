public class Lab extends AbGrade {
	/*// Constructor for a Lab, which only requires a name and worth
	...
	// Constructor for a Lab, which requires a name, a worth, and mark
