public class Test extends AbGrade {
	/*// Constructor for a Test, which only requires a name and worth
	...
	// Constructor for a Test, which requires a name, a worth, and mark
